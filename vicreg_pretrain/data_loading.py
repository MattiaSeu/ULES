    ...
    def __getitem__(self, index: int) -> Tuple[Any, Any]:
        ...
        transform_contrastive = transforms.Compose(
            [
                ...
                transforms.RandomResizedCrop((128, 256), scale=(0.2, 1.0)),
                # transforms.Resize((128, 256), transforms.InterpolationMode.BILINEAR),
        ...
        tra = {'image': transform_image(image), 'img_contrastive': transform_contrastive(image),
        ...
        return [tra['image'], tra['img_contrastive']], tra['target']
